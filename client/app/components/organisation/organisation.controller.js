class OrganisationController {
  constructor() {
    ...
    this.organisation = { _id: 'someId', name: 'Whangarei Food Co-op', tags: 'carrots', tagLine: 'Local - Fresh - Affordable', description: { short: 'spoon hammer fork', long: 'spoon hammer fork mustard cheese' }, address: '1 Woods Road', openingHours: 'Tuesdays 3-6pm', type: 'Co-operitive Company', registration: 'Company Registration Number', gstReg: false, gstNum: 'GST Number', website: 'www.somelpace.co.nz' };
